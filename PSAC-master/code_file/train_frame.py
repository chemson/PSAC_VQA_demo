...
def parse_args():
    ...
    parser.add_argument('--feat_category',type=str,default='c3d')
    parser.add_argument('--feat_path',type=str,default='./data/dataset')
...
if __name__ == '__main__':
    ...
    model = getattr(locals()[model_name], 'build_%s' % args.model)(args.task, args.vid_enc_layers, 1746, args.num_hid, dictionary, args.glove_file_path).cuda()
