...
def parse_args():
    ...
    parser.add_argument('--sentense_file_path',type=str, default='./data')#./data/dataset
    parser.add_argument('--glove_file_path', type=str, default='./data/glove.6B.300d.txt')
    parser.add_argument('--feat_category',type=str,default='resnet')
    parser.add_argument('--feat_path',type=str,default='E:/dataset')#/mnt/data2/lixiangpeng/dataset/tgif/features
...
if __name__ == '__main__':
    ...
    model = getattr(locals()[model_name], 'build_%s' % args.model)(args.task, args.vid_enc_layers, train_dset, args.num_hid, dictionary, args.glove_file_path).cuda(device) #cuda()
